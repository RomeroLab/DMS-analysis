...
rep_all = list(rep1,rep2) # put them in a list

### obtain coefficients and inverse fisher information matrices
py1_rocker  = 0.3
fit_all<- lapply(1:2, fit_repi ,rep_all = rep_all, py1_rep = py1_rocker)
...
# export result
write.csv(res_table[-1,], file="C3_aggregated_result_12only.csv")
